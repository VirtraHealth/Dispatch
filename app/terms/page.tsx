      ...
      <main className="max-w-2xl mx-auto px-6 pt-12 pb-24">
        ...
        <div className="font-serif text-base text-ink leading-[1.85] space-y-8">
          ...
          <section>
            ...
            <p>
              By accessing or using Dispatch (&ldquo;the Service&rdquo;), operated by Virtra Health
          ...
          <section>
            ...
            <p>
              ...
              The Dispatch application, branding, and underlying software are owned by Virtra
              Health and may not be copied, modified, or redistributed without written permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, VIRTRA HEALTH SHALL NOT BE
