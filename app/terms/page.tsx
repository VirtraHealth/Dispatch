...
export const metadata: Metadata = {
  title: 'Terms of Service — My Daily Journal',
  description: 'Terms of Service for using the My Daily Journal daily AI digest.',
}
      ...
      <main className="max-w-2xl mx-auto px-6 pt-12 pb-24">
        ...
        <div className="font-serif text-base text-ink leading-[1.85] space-y-8">
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old to use the Service. By using My Daily Journal, you
          ...
          <section>
            ...
            <ul className="list-disc list-outside ml-5 space-y-2">
              ...
              <li>
                ...
                any activity that occurs under your My Daily Journal account.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              content generated by My Daily Journal is produced from your documents and delivered to you.
              The My Daily Journal application, branding, and underlying software are owned by My Daily Journal and may not be copied, modified, or redistributed without written permission.
            </p>
          </section>
